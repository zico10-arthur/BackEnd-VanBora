...
public interface IMotoristaService
{
    ...
    Task<Result<RegistrarMotoristaResponse>> ObterMotoristaPorId(Guid gerenteId, Guid motoristaId, CancellationToken ct = default);
    ...
    Task<Result<RegistrarMotoristaResponse>> AlternarStatusMotorista(Guid gerenteId, Guid motoristaId, CancellationToken ct = default);
}
