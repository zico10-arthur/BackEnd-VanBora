...
| Spec 50 — Alocação de Recursos à Viagem | Alocar/remover van e motorista a uma viagem específica | Uma viagem só aparece para compradores quando tem van + motorista alocados. Esta spec fecha o ciclo de publicação | 🟠 implementada |
